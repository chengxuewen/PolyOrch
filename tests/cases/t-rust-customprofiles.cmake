...
set(_dargs "-DFIXTURE=${CMAKE_CURRENT_LIST_DIR}/../fixtures/custom-profiles"
           "-DBUILD=${_b}" "-DCONFIG=${_cfg}"
           "-DTARGETS=cargo-build-cp-debug\\;cargo-build-cp-release\\;cargo-build-cp-nodbg\\;cargo-build-cp-dev")
...
if(NOT _rc EQUAL 0)
    message(FATAL_ERROR "rust-customprofiles: driver failed (${_rc})\n${_dlog}")
endif()
